...
| Microsoft + GitHub sign-in | Extends the already-shipped Google sign-in slice with two more providers freelancers/agencies commonly use (Microsoft/Office 365, GitHub) | Anseer request, 2026-08-02 | Done — took prod down twice on first two ship attempts (empty-ClientId crash, see `MODULES.md` Module 3 follow-up slice 1), fixed and verified live 2026-08-03; still needs Anseer to register real OAuth app credentials before either provider is actually clickable |
